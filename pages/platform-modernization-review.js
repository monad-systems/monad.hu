      ...
      >
        ...
        <div className="site-container relative z-10">
          <div style={{ maxWidth: '720px' }}>
            ...
            <h1 className="hero-title">Custom Software Engineering Review</h1>
            <p
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4">
              <Link className="btn btn-hero btn-lg group" href="/#contact">
                Book a Software Engineering Review Call
                <ArrowRightIcon
      ...
      <section className="section">
        <div className="site-container">
          <div className="section-header">
            ...
            <p className="section-lead">
              If two or more of these feel familiar, a software engineering
              review will pay for itself before the roadmap is even finished.
            </p>
          </div>
      ...
      <section className="section">
        <div className="site-container" style={{ textAlign: 'center' }}>
          ...
          >
            ...
            >
              Ready to see what&apos;s holding your software delivery&nbsp;back?
            </h2>
            <p

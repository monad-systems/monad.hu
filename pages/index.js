  ...
  return (
    <div className="app-container">
      <Head>
        ...
        <meta name="description" content="Egyedi szoftverfejelsztés és szaktanácsadás. Web, Mobile, IoT." />
      ...
      <Navbar bg="dark" variant="dark">
        <Container>
          <Navbar.Brand href="/" className="py-0 d-flex align-items-center">
            <Image src="/v1629058574/logo_kpn698.svg" className="d-inline-block align-top" alt="MONAD SYSTEMS logo" width={133} height={38} />
          </Navbar.Brand>
